...
namespace DbSession.Sqlite
{
    public class Connection : IConnection
    {
        ...
        private static SqlCommand PrepareCommand(SqlConnection connection, string sql, SqlParameterSet parameters)
        {
            ...
            if (parameters != null)
            {
                foreach (var parameter in parameters)
                {
                    command.Parameters.Add(
                        new System.Data.SqlClient.SqlParameter(parameter.Name, Types[parameter.Type])
                        {
